...
function edit_GET(Web $w)
{
    ...
    $form = [
        "Add Report Template" => [
            [
                ["Template", "select", "template_id", $report_template->template_id, TemplateService::getInstance($w)->findTemplates("report")]
            ],
            [
                ["Type", "select", "type", $report_template->type, $report_template->getReportTypes()]
            ],
            [
                ["Use in emailed reports", "checkbox", "is_email_template", $report_template->is_email_template]
            ],
            [
                ["Report ID", "hidden", "report_id", $p['report_id']]
            ]
        ]
    ];

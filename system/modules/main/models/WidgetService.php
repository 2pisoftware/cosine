...
class WidgetService extends DbService
{
    ...
    {
        return $this->getObject("WidgetConfig", [
    ...
    {
        return $this->getObjects("WidgetConfig", ["is_deleted" => 0]);
    }

    public function getWidgetsForModule($destination_module, $user_id)
    {
        return $this->getObjects("WidgetConfig", [
            "user_id" => $user_id,
    ...
    {
        return $this->getObject("WidgetConfig", ["id" => $id, "is_deleted" => 0]);
    }
}

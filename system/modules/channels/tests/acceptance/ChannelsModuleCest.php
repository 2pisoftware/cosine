...
class ChannelsModuleCest
{
    ...
    public function testChannelsModule($I)
    {
        ...
        $I->createEmailChannel(
            ...
            $channel_body,
            "Archive",
            $channel_post_read_data
        );
        $I->verifyEmailChannel(
            $I,
            $channel_name,
            false,
            false,
        ...
        $I->editEmailChannel(
            ...
            "IMAP",
            $channel_url_edited,
            $channel_username_edited,
            $channel_password_edited,
            $port,
            false,
            true,
            false,
            $channel_folder_edited,
            $to_edited,
            $from_edited,
            $cc_edited,
            $channel_subject_edited,
            $channel_body_edited,
            "Move to Folder",
            $channel_post_read_data_edited
        );
        $I->verifyEmailChannel(
            $I,
            $channel_name_edited,

...
class AdminBulkEmails extends CmfiveMigration
{
    ...
    public function up()
    {
         ...
         */
        if ($this->hasTable('attachment') && !$this->tableWithId("attachment")->hasColumn("is_public")) {
            $this->tableWithId("attachment")->addBooleanColumn("is_public")->save();
        }
    }
    ...
    public function down()
    {
        ...
        $this->hasTable('attachment') && $this->tableWithId("attachment")->hasColumn("is_public") ? $this->tableWithId('attachment')->removeColumn('is_public') : null;
    }
}

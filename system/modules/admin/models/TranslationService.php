...
class TranslationService extends DbService
{
    ...
    function translate($key, $parameters = [])
    {
        ...
        if (!empty($submodule)) {
            ...
            } elseif (!empty(Config::get("translations." . $module . "." . $action . "." . $key))) {
                $result = Config::get("translations." . $module . "." . $action . "." . $key);
                // path to submodule
            } elseif (!empty(Config::get("translations." . $module . "." . $submodule . "." . $key))) {
                $result = Config::get("translations." . $module . "." . $submodule . "." . $key);
                // path to module
            } elseif (!empty(Config::get("translations." . $module . "." . $key))) {

<form action="<?php echo WEBROOT; ?>/file/attach" method="POST" enctype="multipart/form-data">
    ...
    <table class="form" width="100%">
        <tr>
            <td class='section' colspan='2'>Attach a File</td>
        </tr>
        <?php if (!empty($types) && count($types)) : ?>
            <tr>
                <td nowrap='true'>Attachment Type</td>
                <td><?php echo HtmlBootstrap5::select("type_code", $types); ?></td>
            </tr>
        <?php endif; ?>
        <tr>
            <td nowrap='true'>File</td>
        ...
        <tr>
            <td colspan='2'><textarea name="description" cols="30" rows="5"></textarea></td>
        </tr>
        <tr>
            <td colspan='2'><input type="submit" name="" value="Upload" /></td>
        </tr>
